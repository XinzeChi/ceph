...
wget -O test_rados.py "https://ceph.com/git/?p=ceph.git;a=blob_plain;hb=hammer;f=src/test/pybind/test_rados.py" || \
    wget -O test_rados.py "https://ceph.com/git/?p=ceph.git;a=blob_plain;hb=ref/heads/hammer;f=src/test/pybind/test_rados.py"
