...
class LibRadosTwoPoolsECPPPartialRead : public RadosTestECPP
{
public:
  LibRadosTwoPoolsECPPPartialRead() {};
...
std::string LibRadosTwoPoolsECPPPartialRead::cache_pool_name;


TEST_F(LibRadosTwoPoolsECPPPartialRead, ProxyRead) { // the object size > stripe_width
  // create object
...
TEST_F(LibRadosTwoPoolsECPPPartialRead, ProxyRead1) { // the object size < chunk_size
  // create object
  const uint64_t chunk_size = 2048; // default value
...
TEST_F(LibRadosTwoPoolsECPPPartialRead, ProxyRead2) { // the object size == chunk_size
  // create object
  const uint64_t chunk_size = 2048; // default value
